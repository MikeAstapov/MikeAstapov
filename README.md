...
__Привет ;)<br> Меня зовут Михаил, я являюсь QA инженером. <br> У меня есть опыт работы с различными инструментами (Postman, Swagger, DevTools, Allure TestOps, Git, Docker, Kibana и OpenSearch ,  а также с базами данных (как реляционными, так и nosql), включая MySQL, PostgreSQL, Redis, MongoDB.<br> Конечно же знаю и о тестирование API (REST и QRAPHQL).
